...
export const dictionary: Record<LocaleCode, Dictionary> = {
  en: {
    ...
    hero_eyebrow: "Taxi associations, now online",
    hero_title: "Ride Local. Deliver Faster. Grow Together.",
    hero_subtitle:
      "Book a taxi, three-wheeler, van, or lorry from a verified driver in your own taxi association — fair fares, transparent commissions, and a platform built for Sri Lanka.",
  ...
  si: {
    ...
    hero_eyebrow: "ටැක්සි සංගම් දැන් අන්තර්ජාලයේ",
    hero_title: "ගමන ලෝකලයි. ආදායමත් එසේමයි.",
    hero_subtitle:
      "ඔබේම ටැක්සි සංගමයේ සත්‍යාපිත රියදුරෙකුගෙන් ටැක්සියක්, ත්‍රී රෝදයක්, වෑන් රථයක් හෝ ලොරි රථයක් වෙන් කරගන්න.",
  ...
  ta: {
    ...
    hero_eyebrow: "டாக்சி சங்கங்கள், இப்போது இணையத்தில்",
    hero_title: "பயணம் உள்ளூர். வருமானமும் அப்படியே.",
    hero_subtitle:
      "உங்கள் சொந்த டாக்சி சங்கத்தின் சரிபார்க்கப்பட்ட ஓட்டுநரிடமிருந்து டாக்சி, முச்சக்கர வண்டி, வேன் அல்லது லாரியை முன்பதிவு செய்யுங்கள்.",
